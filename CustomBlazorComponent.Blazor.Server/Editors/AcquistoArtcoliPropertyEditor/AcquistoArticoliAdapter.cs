...
{
    public class AcquistoArticoliAdapter: ComponentAdapterBase
    {
        public AcquistoArticoliAdapter(AcquistoArticoliModel componentModel)
        {
        ...
        public override AcquistoArticoliModel ComponentModel { get; }
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, AcquistoArticoliRenderer.Create(ComponentModel));
        }
